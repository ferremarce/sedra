...
ALTER TABLE public.configuracion ADD "validator" varchar(255) NULL;
...
UPDATE public.permiso SET descripcion_permiso='Carátula de Documento', nivel='4.1', orden=NULL, tag_menu='#{ReporteController.imprimirDelantalSetup}', url_imagen='fa fa-scroll', nivel_acceso='admin', con_separador=NULL WHERE id_permiso=14;
