...
import sedra.fachada.PermisoRolFacade;
import sedra.fachada.RolFacade;
import sedra.modelo.Permiso;
import sedra.modelo.PermisoRol;
...
///---------------------METODOS---------------------///
    ...
    public SelectItem[] getRolCheckSet() {
        return JSFutil.getSelectItems(this.rolFacade.findAll(), Boolean.FALSE);
    }
}
